...
It is then followed by Antony's delegate interaction by delegating the vote to Linus using (scripts/delegate.ts), which leads to increasing the Binance's vote by 1.   
